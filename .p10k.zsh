# Generated by Powerlevel10k configuration wizard on 2024-09-27 at 16:27 UTC.
...
() {
  ...
  function prompt_pulumi() {
  local stack=$(pulumi stack select --show-name 2>/dev/null)
  if [[ -n $stack ]]; then
    echo -n "%F{cyan}Pulumi:%f%F{blue}$stack%f "
  fi
}
